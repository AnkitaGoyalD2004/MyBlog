            ...
            {data?.map((post) => (
                <Card key={post._id} className="pt-0">
                    <div className="relative h-48 w-full overflow-hidden">
                        <Image src={post.imageURl ?? "https://images.unsplash.com/photo-1682613375621-c10d167c852e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDEyfDZzTVZqVExTa2VRfHxlbnwwfHx8fHw%3D"} alt="image" fill className="rounded-t-lg object-cover" unoptimized />
                    </div>
